 ...
 * color?)
 */
enum lcd_surface_blit_flag_e {
    /**
     * @brief Nothing.
     * @details This just copies the pixels as-is.
     */
    LCD_SURFACE_BLIT_NONE = 0,
    /**
     ...
     */
    LCD_SURFACE_BLIT_ALPHA_BLENDING_FAST = 0x10,
};
